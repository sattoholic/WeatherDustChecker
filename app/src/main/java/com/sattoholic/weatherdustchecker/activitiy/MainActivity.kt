...
class MainActivity : AppCompatActivity() {
    ...
    private val viewModel by lazy { ViewModelProvider(this, FragmentsViewModelFactory(repository!!)).get(
        FragmentsViewModel::class.java) }
    private val adapter = ViewPagerAdapter(this)
    private val repository by lazy { WeatherDustApplication.getInstance(resources.getString(R.string.OPEN_WEATHER_API), resources.getString(R.string.DUST_APP_TOKEN)).repository }
